...
if (colorDomSelect) {
    colorDomSelect.addEventListener('input', function () {
        ...
        bgcolor.innerHTML = `${bgColorVal.join(', ')} { background-color: ${color}; }`;
        normalColor.innerHTML = `${normalColorVal.join(', ')} { color: ${color}; }`;
        borderTopColor.innerHTML = `${borderTopColorVal.join(', ')} { border-top-color: ${color}; }`;
        borderBottomColor.innerHTML = `${borderBottomColorVal.join(', ')} { border-bottom-color: ${color}; }`;
    ...
    $('.admin-color-btn-reset').on('click', function () {
        ...
        colorDomSelect.value = defaultColor;
        colorDomSelect.dispatchEvent(new Event('input'));
    });
}
